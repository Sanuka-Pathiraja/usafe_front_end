...
class SilentCallBottomSheet extends StatefulWidget {
  ...
  @override
  State<SilentCallBottomSheet> createState() => _SilentCallBottomSheetState();
}

class _SilentCallBottomSheetState extends State<SilentCallBottomSheet> {
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle:
                              const TextStyle(color: AppColors.textSecondary),
                          filled: true,
                          fillColor: AppColors.background.withOpacity(0.45),
