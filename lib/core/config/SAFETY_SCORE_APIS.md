...
1. **Population density** – District-based density (census) + POI count (OpenStreetMap) so busier areas score safer.
...
| Population density | Sri Lanka districts + Overpass POIs | District density + nearby shops/restaurants count |
